...
sidebar = pygame.Surface((80, screen_height - 20), pygame.SRCALPHA)
...
def update_sidebar(image: pygame.Surface = sidebar):
    ...
    pygame.draw.rect(background, (0, 0, 0), pygame.Rect(
        10, 10, background.get_width()-10, background.get_height()-20))
    if not lightmode:
